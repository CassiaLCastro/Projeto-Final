...
function adicionarInicial() {
    contInicial += 50;
    inicial.innerHTML = contInicial.toLocaleString('pt-br',{style: 'currency', currency: 'BRL'});
    calcular();
}
...
function adicionarMensal() {
    contMensal += 50;
    mensal.innerHTML = contMensal.toLocaleString('pt-br',{style: 'currency', currency: 'BRL'});
    calcular();
}
